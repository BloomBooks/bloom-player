...
const converted = OldQuestionsConverter.convert("[{\"questions\":[{\"question\":\"How did the boy lose his cap\",\"answers\":[{\"text\":\"The bully took it\",\"correct\":false},{\"text\":\"The wind blew it away\",\"correct\":true},{\"text\":\"He left it on the bus\",\"correct\":false}]},{\"question\":\"What did the moon do?\",\"answers\":[{\"text\":\"Hid behind clouds\",\"correct\":false},{\"text\":\"Appeared to wear the cap\",\"correct\":true}]}],\"lang\":\"sp\"}]",
"Device16x9Portrait")
...
const checkTranslationGroup = (group: HTMLElement, paraContent: string, editableStyle: string, lang: string) => {
...
test("correct questions", () => {
    const firstQuestion = converted[0].firstElementChild!.firstElementChild!.firstElementChild as HTMLElement;
    checkTranslationGroup(firstQuestion, "How did the boy lose his cap", "QuizQuestion-style", "sp");
    const secondQuestion = converted[1].firstElementChild!.firstElementChild!.firstElementChild as HTMLElement;
    checkTranslationGroup(secondQuestion, "What did the moon do?", "QuizQuestion-style", "sp");
});
...
test("correct answers", () => {
    const firstQuiz = converted[0].firstElementChild!.firstElementChild as HTMLElement;
    ...
    const secondQuiz = converted[1].firstElementChild!.firstElementChild as HTMLElement;
