...
// The pure selector-rewriting logic lives in a separate module so it can be unit-tested
// directly (scoped-styles-polyfill.test.ts) rather than against a duplicated copy.
