...
export class BloomPlayerCore extends React.Component<IProps, IState> {
    ...
    handleDocumentLevelClick(e: any) {
        ...
        if (targetElement && targetElement.attributes["data-href"]) {
            const href = targetElement.attributes["data-href"].value;
            if (href) {
                if (href.startsWith("#")) {
                    ...
                    // (Maybe we should send a message to the host instead?  or can the
                    // host intercept this and open a browser to handle it?)
