...
export const BloomPlayerControls: React.FunctionComponent<IProps &
    ...
    const scalePageToWindow = () => {
        ...
        if (showAppBar) {
            ...
            const pageNumberSlider = document.getElementById(
                "pageNumberSlider"
            );
            if (pageNumberSlider) {
                controlsHeight += pageNumberSlider.offsetHeight;
            }
        }
            ...
            {showAppBar && (
                <div id="pageNumberSlider">
                    <PageSlider
                        ...
                        // continuous scrolling would probably be too slow to allow the slider to be
