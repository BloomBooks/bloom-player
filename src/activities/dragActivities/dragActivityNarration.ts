...
// We need to be able to play it both during "Try it" and when showing the page in BP.
...
// At this stage, I don't know how we will handle having both narration and video
// that should autoplay at the same time, and indeed, have not yet tried to handle
// autoplaying video in a drag activity page. Nor have I tried to handle pause/resume.
